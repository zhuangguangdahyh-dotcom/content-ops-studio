...
Local command boundary for the recoverable V0.2.0 Runtime. It requires Node.js 24 LTS (`>=24 <25`) and exposes doctor, Pack resolution, project inspection/creation, run start/status/approval/resume/verify, and working-tree baseline commands.
